...
def _seed_general_clock(conn) -> int:
    ...
    slots = [
        ...
        (4, "MUSIC", "B", "FLOAT", "MIX", "Recurrent"),
        (5, "PROMO", "PR", "SOFT", "AUTO", "Promo"),
        (6, "MUSIC", "A", "FLOAT", "MIX", "Power"),
        (7, "SWEEPER", "SW", "FLOAT", "AUTO", "Sweeper"),
        (8, "MUSIC", "C", "FLOAT", "MIX", "Gold"),
        (9, "MUSIC", "B", "FLOAT", "MIX", "Recurrent"),
        (10, "MUSIC", "A", "FLOAT", "MIX", "Power"),
        (11, "ETM", None, "HIT", "HOLD", "ETM / stopset window"),
        (12, "BREAK", None, "HARD", "MANUAL", "Stopset / break"),
        (13, "MUSIC", "B", "FLOAT", "MIX", "Recurrent"),
        (14, "SWEEPER", "SW", "FLOAT", "AUTO", "Sweeper"),
        (15, "MUSIC", "A", "FLOAT", "MIX", "Power"),
        (16, "MUSIC", "C", "FLOAT", "MIX", "Gold"),
        (17, "MUSIC", "A", "FLOAT", "MIX", "Power close"),
    ]
